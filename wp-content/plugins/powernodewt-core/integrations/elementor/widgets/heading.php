...
class Heading extends Widget_Base {
	...
	public function get_name() {
		return 'powernode-heading';
	}
	
	public function get_title() {
		return __( 'Heading', 'powernodewt-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Add Your Heading Text Here', 'powernodewt-core' ),
	...
	protected function render() {
		...
		echo powernodewt_heading( $settings, $settings['content'] );
