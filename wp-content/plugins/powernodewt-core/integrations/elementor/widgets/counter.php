...
class Counter extends Widget_Base {
	...
	public function get_name() {
		return 'powernode-icon-box';
	}
	
	public function get_title() {
		return __( 'Counter', 'powernodewt-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_counter',
			[
				'label' => esc_html__( 'Counter', 'powernodewt-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Number Prefix', 'powernodewt-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Number Sufix', 'powernodewt-core' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Animation Duration', 'powernodewt-core' ),
				'type' => Controls_Manager::NUMBER,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'This is the heading', 'powernodewt-core' ),
		...
		$this->start_controls_section(
			'section_style_counter_num',
			[
				'label' => esc_html__( 'Counter Number', 'powernodewt-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
				
		$this->add_control(
			'heading_counter_number_style',
			[
				'label' => esc_html__( 'Counter Number', 'powernodewt-core' ),
		...
		$this->add_control(
			'counter_num_color_custom',
			[
				'label' => __( 'Custom Color', 'powernodewt-core' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#222',
				'condition' => [
					'counter_num_color' => 'custom',
				],
			]
		);
	...
	protected function render() {
		...
		echo powernodewt_counter( $settings, $settings['content'] );
