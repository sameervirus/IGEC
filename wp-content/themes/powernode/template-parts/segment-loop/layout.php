...
$sub_atts = array();
$sub_atts['class'] = array( 'entry-post', 'segment-post' );
...
if( $post_style == 'box' && !empty( $sections ) ) { ?>
	<div class="gallery-image">
		...
		<?php echo ( in_array( 'thumbnail', $sections ) ) ? get_template_part( 'template-parts/segment-loop/thumbnail' ) : ''; ?>
		<div class="item-overlay"></div>

		<div <?php echo powernodewt_stringify_atts( $content_args ); ?>>
			<div class="project-meta-txt">
				<?php echo ( in_array( 'meta', $sections ) ) ? get_template_part( 'template-parts/segment-loop/meta' ) : ''; ?>
				<?php echo ( in_array( 'categories', $sections ) ) ? get_template_part( 'template-parts/segment-loop/categories' ) : ''; ?>
				<?php echo ( in_array( 'title', $sections ) ) ? get_template_part( 'template-parts/segment-loop/title' ) : ''; ?>
				<?php echo ( in_array( 'content', $sections ) ) ? get_template_part( 'template-parts/segment-loop/content' ) : ''; ?>
				<?php echo ( in_array( 'social-links', $sections ) ) ? get_template_part( 'template-parts/segment-loop/social-links' ) : ''; ?>
			</div>
			<?php echo ( in_array( 'read-more', $sections ) ) ? get_template_part( 'template-parts/segment-loop/read-more' ) : ''; ?>
		</div>
...
<?php } else { ?>
	...
	<?php		
		foreach ( $sections as $section ) :
				...
				get_template_part( 'template-parts/segment-loop/'. $section  );
