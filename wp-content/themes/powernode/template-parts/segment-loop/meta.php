...
$sections	= powernodewt_segment_post_meta();
...
?>
<div class="entry-segment-meta mb-10 post-author">
	
	<?php do_action( 'powernodewt_before_segment_post_archives_meta' ); ?>
	...
	<?php foreach ( $sections as $section ) :
		...
		switch ( $section ) {
			case 'author': ?>	
				...
				break;
			case 'categories':
				$categories_list = get_the_term_list(get_the_ID(), 'segment-cat', '', ', ', '');
				if ( $categories_list ) {?>					
	...
	<?php do_action( 'powernodewt_after_segment_post_archives_meta' ); ?>	
